...
const en: Dictionary = {
  ...
  connect: {
    ...
    lead: "Whether you're looking for engineering leadership guidance, exploring collaboration opportunities, or just want to connect — I'd love to hear from you.",
    book: 'Subscribe',
  },
  newsletter: {
    eyebrow: 'Newsletter',
