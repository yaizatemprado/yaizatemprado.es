...
const es: Dictionary = {
  ...
  connect: {
    eyebrow: 'Contacto',
    heading: 'Empecemos una conversación',
    lead: 'Tanto si buscas orientación sobre liderazgo en ingeniería, como si exploras oportunidades de colaboración o simplemente quieres conectar — me encantaría saber de ti.',
    book: 'Suscríbete',
  },
  newsletter: {
    eyebrow: 'Newsletter',
